...
class OdriveConfiguration:
    ...
    def set_odrive_parameters(self):
        ...
        # odrv1 parameter config
        self.odrv1.axis0.motor.config.pole_pairs = 15
        self.odrv1.axis0.motor.config.resistance_calib_max_voltage = 4
        self.odrv1.axis0.motor.config.requested_current_range = 25 
        self.odrv1.axis0.motor.config.current_control_bandwidth = 100

        self.odrv1.axis1.motor.config.pole_pairs = 15
        self.odrv1.axis1.motor.config.resistance_calib_max_voltage = 4
        self.odrv1.axis1.motor.config.requested_current_range = 25 
        self.odrv1.axis1.motor.config.current_control_bandwidth = 100

        self.odrv1.axis0.motor.config.torque_constant = 8.27 / 16
        self.odrv1.axis0.encoder.config.mode = ENCODER_MODE_HALL
        self.odrv1.axis0.encoder.config.cpr = 90
        self.odrv1.axis0.encoder.config.calib_scan_distance = 150

        self.odrv1.axis1.motor.config.torque_constant = 8.27 / 16
        self.odrv1.axis1.encoder.config.mode = ENCODER_MODE_HALL
        self.odrv1.axis1.encoder.config.cpr = 90
        self.odrv1.axis1.encoder.config.calib_scan_distance = 150

        self.odrv1.axis0.encoder.config.bandwidth = 100
        self.odrv1.axis0.controller.config.pos_gain = 1
        self.odrv1.axis0.controller.config.vel_gain = 0.02 * self.odrv1.axis0.motor.config.torque_constant * self.odrv1.axis0.encoder.config.cpr
        self.odrv1.axis0.controller.config.vel_integrator_gain = 0.1 * self.odrv1.axis0.motor.config.torque_constant * self.odrv1.axis0.encoder.config.cpr
        self.odrv1.axis0.controller.config.vel_limit = 10

        self.odrv1.axis1.encoder.config.bandwidth = 100
        self.odrv1.axis1.controller.config.pos_gain = 1
        self.odrv1.axis1.controller.config.vel_gain = 0.02 * self.odrv1.axis0.motor.config.torque_constant * self.odrv1.axis1.encoder.config.cpr
        self.odrv1.axis1.controller.config.vel_integrator_gain = 0.1 * self.odrv1.axis0.motor.config.torque_constant * self.odrv1.axis1.encoder.config.cpr
        self.odrv1.axis1.controller.config.vel_limit = 10

        self.odrv1.axis0.controller.config.control_mode = CONTROL_MODE_VELOCITY_CONTROL
        self.odrv1.axis1.controller.config.control_mode = CONTROL_MODE_VELOCITY_CONTROL

        self.odrv1.config.enable_brake_resistor = True
        
        self.odrv1.axis0.motor.config.current_lim = 5
        self.odrv1.axis0.motor.config.calibration_current = 5
        self.odrv1.axis0.encoder.config.hall_polarity_calibrated = True 

        self.odrv1.axis1.motor.config.current_lim = 5
        self.odrv1.axis1.motor.config.calibration_current = 5
        self.odrv1.axis1.encoder.config.hall_polarity_calibrated = True 
    ...
    def motor_calibration(self):
        ...
        self.odrv1.axis0.requested_state = AXIS_STATE_MOTOR_CALIBRATION
        # Wait for calibration to take place
        time.sleep(10)
        self.odrv0.axis0.motor.config.pre_calibrated = True
        self.odrv1.axis0.motor.config.pre_calibrated = True

        self.odrv0.axis1.requested_state = AXIS_STATE_MOTOR_CALIBRATION
        self.odrv1.axis1.requested_state = AXIS_STATE_MOTOR_CALIBRATION
        # Wait for calibration to take place
        time.sleep(10)
        self.odrv0.axis1.motor.config.pre_calibrated = True
        self.odrv1.axis1.motor.config.pre_calibrated = True
    
    def encoder_calibration(self):
        self.odrv0.axis0.requested_state = AXIS_STATE_ENCODER_OFFSET_CALIBRATION
        self.odrv1.axis0.requested_state = AXIS_STATE_ENCODER_OFFSET_CALIBRATION
        # Wait for calibration to take place
        time.sleep(30)
        self.odrv0.axis0.encoder.config.pre_calibrated = True
        self.odrv1.axis0.encoder.config.pre_calibrated = True
        
        self.odrv0.axis1.requested_state = AXIS_STATE_ENCODER_OFFSET_CALIBRATION
        self.odrv1.axis1.requested_state = AXIS_STATE_ENCODER_OFFSET_CALIBRATION
        # Wait for calibration to take place
        time.sleep(30)
        self.odrv0.axis1.encoder.config.pre_calibrated = True
        self.odrv1.axis1.encoder.config.pre_calibrated = True
    ...
    def operation_check(self):
        ...
        self.odrv1.axis0.controller.input_vel = 2
        self.odrv1.axis1.controller.input_vel = -2
